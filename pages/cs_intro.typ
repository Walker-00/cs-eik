...
ရေးထားတာပဲဖြစ်ပါတယ်။ ကျွန်တော်တို့ သိတာတွေရေးတဲ့အတွက် မမှန်ရင်လည်း မမှန်နိုင်သလို မှားလည်းမှားနိုင်ပါတယ်။ အကယ်လို့
အမှားပြင်ချင်တယ် ကိုယ်သိတာလေးတွေထည့်ရေးပြီး Contributors (Co-Author) credit လိုချင်ရင်တော့ ဒီစာအုပ် project
ရဲ့ #link("https://github.com/Walker-00/cs-eik")[Github Repo] ကို fork လုပ်ပြီးတော့ဖြစ်ဖြစ်
issue ဖွင့်ပြီး အကြံပေးတာဖြစ်ဖြစ် လုပ်လို့ရပါတယ်။ ကျွန်တော်တို့ရဲ့ Main ရည်ရွယ်ချက်က Computer Science ကိုဘာ
Background မှ မရှိတဲ့ သူကနေစပြီး စိတ်ပါဝင်စားတဲ့ ဘယ်သူပဲဖြစ်ဖြစ် ဘာတန်ဖိုးမှ ပေးစရာမလိုပဲ အလကား လေ့လာနိုင်ဖို့
အတွက်ရည်ရွယ်ပါတယ်။

== Authors တွေရဲ့ အသိပေးချက်
ဒီစာအုပ်က စစချင်းတော့ အရမ်းပြည့်စုံမှာ မဟုတ်သလို ကိုယ်သိချင်တဲ့ အကြောင်းအရာတွေ ကိုယ်သိပြီးသား အကြောင်းအရာတွေလည်း စစချင်း
မပါနိုင်သေးပါဘူး။ ကျွန်တော်လည်း အလုပ်တစ်ဖက် သင်တန်းတစ်ဖက်နဲ့ လုပ်နေရတာကြောင့်ပါ။ ဒါပေမဲ့ လိုတာတွေကို နည်းနည်းစီဖြည့်ဖြည့်ပြီး
အဆင်ပြေလောက်တဲ့ အချိန်ကျရင် edition တစ်ခုချင်းစီ ထုတ်ပေးသွားမှာပါ။

== License and Code Of Conduct
ဒီ project ရဲ့ license ကိုတော့ #link("http://www.wtfpl.net/")[WTFPL] သုံးထားပါတယ်။ License
အရ ဘာမဆိုလုပ်လို့ရတယ်ဆိုပေမဲ့။ Non-Profit Sharing အတွက်ပဲ ခွင့်ပြုပါတယ်။ ပြန်ရောင်းတာမျိုး မလုပ်ဖို့ ခွင့်ပန်ပါတယ်။
အကယ်၍ တစ်ယောက်ယောက်က ရောင်းခဲ့ရင်လည်း။ ဒီစာအုပ်ဟာ Online Book PDF file အနေနဲ့ အလကားဖတ်လို့လည်း ရသလို၊
ကိုယ်တိုင် သိသလောက်ဝင်ရေးလို့ရတယ် ဆိုတာ အသိပေးပါရစေ။ ပြန်ရောင်းပေမဲ့ profit ထဲက 25%+ လောက်လိုအပ်တဲ့ နေရာတွေကို ပြန်ပြီး
Donate လုပ်ပေးရင် ကောင်းပါမယ်ဗျ။
...
Fun Fact အနေနဲ့ကတော့ CPU ထုတ်လုပ်တဲ့ နေရာ စက်ရုံတွေက ဆေးရုံက ခွဲစိတ်ခန်း ထက်ကို ပိုပြီး သန့်ရှင်းနေရပါတယ်။
ဘာလို့လဲ ဆိုတော့ CPU လုပ်တဲ့ နေရာမှာ အမှားပါတာ Radiation ဖြစ်တာ တစ်ခုခုဖြစ်သွားရင် Bit Flip ဆိုတာ ဖြစ်သွားနိုင်ပါတယ်။
Bit Flip ဆိုတာကတော့ Computer ရဲ့ CPU က အလုပ်လုပ်ပေးတဲ့ binary number မှာ ပုံမှန်မဟုတ်ပဲ ပြောင်းလဲတာကိုခေါ်တာပါ။
ဥပမာ ပုံမှန်က 010 ဆိုပြီး ရှိရမဲ့ အစား Radiate ဖြစ်သွားပြီး 100 ဖြစ်သွားတာတို့ 001 ဖြစ်သွားတာတို့လို ပြောင်းသွားတာကို ဆိုလိုတာပါ။
သာမာန်ကြည့်ရင်တော့ ဘာမှမဟုတ်လောက်ဘူးထင်ရပေမဲ့ တစ်ကဲ့ အရေးကြီးတဲ့ မဲပေးတာတို့ ဆေးရုံက system တွေမှာတို့ အာကာသ system တွေ
မှာလို တစ်ကဲ့ အရေးကြီးတဲ့ နေရာတွေဆို လူ့အသက်တွေ သာမက ကြီးမားတဲ့ ဆုံးရှုံးမှုတွေ အများကြီးဖြစ်စေနိုင်ပါတယ်။
...
အရမ်း Simple ဖြစ်တဲ့ စာပဲ ထုတ်ပြသေးတဲ့ OS လေးကို Rust နဲ့ ရေးနည်း ကြည့်ချင်ရင် ကျွန်တော့ရဲ့ #link("https://github.com/Walker-00/chaos")[ChaOS]
ဆိုတဲ့ OS လေးကို ကြည့်ကြည့်လို့ရပါတယ်။
...
Xfce တို့လိုပါ။ Simple ဖြစ်တဲ့ Window Manager ကို rust မှာ ဘယ်လိုရေးရလဲဆိုတာကို ကျွန်တော့ရဲ့ #link(
  "https://github.com/Walker-00/sswm",
)[SSWM (Saffron Spring Window Manager)] Github Repo လေးမှာ ဝင်ကြည့်လို့ရပါတယ်။

#pagebreak()

#align(center, [= တစ်ခြား Computer Science နဲ့ ပတ်သက်တဲ့ အကြောင်းအရာများ])

== Networking အကြောင်း
Computer တွေကလည်း လူတွေလိုပါပဲ လူတွေ တစ်ယောက်နဲ့ တစ်ယောက် စကားပြော အဖွဲ့အစည်းဖွဲ့ကြ အသိပညာတွေ မျှဝေကြသလိုပဲ။
Computer တွေကလည်း သူတို့အချင်းချင်း ချိတ်ဆက်ပြီး အသုံးပြုသူလိုချင်တဲ့ အချက်အလက်တွေ ရှာတာ တွေလုပ်ဆောင်ပေးရပါတယ်။
ဒီနေရာမှာ Networking ကိုသိဖို့လိုလာပါတယ်၊ ကိုယ်တွေ တစ်ယောက်နဲ့ တစ်ယောက် စကားပြောဖို့ အလုပ်အကိုင် အခွင်အလမ်းတွေရချင်လို့
ဘာသာစကားတွေ သင်သလိုပါပဲ Computer Networking ကို သေချာနားလည်ထားတာကလည်း Internet အလုပ်လုပ်ပုံနဲ့ Computer
တွေ ဘယ်လို ချိတ်ဆက်ပြီး ဘယ်လိုတွေအလုပ်လုပ်ကြသလဲ ဆိုတာကို နားလည်လာစေမဲ့အပြင် Network Engneering, System Admin နဲ့
Cyber Sce တို့လို လစာကောင်းတဲ့ အလုပ်ခွင်ထဲ ဝင်ဖို့ Foundation လည်း ရလာစေပါတယ်။

=== Computer ရဲ့ Networking ဆိုတာဘာလဲ
လူအများစုက Networking ကို Internet ဒါမှမဟုတ် WWW ( World Wide Web ) နဲ့ အထင်မှားတတ်ကြပါတယ်။
တစ်ကယ်တော့ မတူပါဘူး Networking ဆိုတာ Internet နဲ့ WWW တို့လို နည်းပညာတွေ ဖြစ်ပေါ်အောင် ပံ့ပိုးပေးထားတဲ့ အဓိက ထောက်တိုင်ကြီးပါ။
မတူညီတဲ့ Networking စနစ်တွေ ဥပမာ TCP, UDP စတဲ့ နည်းပညာတွေ အပေါ်မှာ မူတည်ပြီး Internet နဲ့ WWW တို့ကဖြစ်ပေါ်လာရတာပါ။
Networking မှာတော့ မတူညီတဲ့ Networks တွေရှိမယ်။ Network အလိုက် မတူညီတဲ့ လုပ်ဆောင်မှုတွေလုပ်ဆောင်လို့ရတယ်။
အချက်အလက်တွေ ပို့ဖို့ မတူညီတဲ့ အချက်အလက်ပို့တဲ့ Protocol တွေရှိမယ်။ Protocol အလိုက် မတူညီတဲ့ အားသာချက်အားနည်းချက် လုပ်ဆောင်လို့ရတာတွေရှိတယ်။
သူတို့အချင်းချင်း စကားပြောဖို့ ဘယ်သူကပြောနေတယ်ဆိုတာ သိဖို့ မတူညီတဲ့ IP တွေရှိမယ်။ Networking လုပ်တဲ့ အခါ အရမ်းခတ်လာပြီလို့ ထင်လာရင်
ရည်းစာစာ ပို့တာနဲ့ နှိုင်းယှဥ်ပြီးတွေးကြည့်ပါ ကျွန်တော်လည်း တစ်ချို့ ခတ်မယ်ထင်ရတဲ့ နေရာတွေမှာ ယှဥ်ပြီး ပြောပြပေးပါမယ်။

=== Networks တွေ Network Interface တွေ Protocol တွေ IP တွေက ဘာတွေလဲ
Computer Network ဆိုတာကတော့ တစ်ခုထက်ပိုတဲ့ Computer တွေချိတ်ဆက်ထားတာကို ခေါ်တာပါ။ ဥပမာဆိုရင် Wifi/Router စက်နဲ့ ချိတ်ဆက်ထားတာတို့ ပါ။
နေရာနဲ့လိုက်ပြီး Network ရဲ့ နာမည်နဲ့ အသုံးပြုပုံတွေကလည်း ကွာနိုင်ပါတယ်။ ဥပမာ Home Network ဆိုရင် အိမ်မှာရှိတဲ့ Computer အချင်းချင်း File Share တာတို့
ဘာတို့လုပ်ကြတယ် School Network ဆိုရင် ကျောင်းနဲ့ဆိုင်တာ ဘာညာပေါ့ နားမလည်သေးရင် လူတွေရဲ့ Network နဲ့မှန်းကြည့်လို့ရပါတယ်။ ဥပမာ အိမ်က မိသားစုနဲ့ဆိုရင်
နေချင်သလိုနေ ပြောချင်တာပြောလုပ်တယ်၊ ကျောင်းမှာဆိုရင် ကျောင်းက သူတွေနဲ့ စာအကြောင်း ဘာညာ ဒိလိုပေါ့။
Internet ဆိုတာကတော့ Inter Network ရဲ့အတိုကောက်ပါ သူက Network တွေအများကြီးစုစီးထားတဲ့ Network တစ်ခုပါပဲ ဥပမာ School Network နဲ့ Home Network
ချိတ်ဆက်ပြီး School Network ကနေ Home Network ကို စာတွေပို့တာ ဘာညာသဘောမျိုးပါ။
Network Interface ဆိုတာကတော့ Network တစ်ခုကို Computer က ဘယ်လိုချိတ်ဆက်ထားတာလဲ ဆိုတာကိုခေါ်တာပါ။ ဥပမာ အိမ်တစ်အိမ် နဲ့ နောက်တစ်အိမ်
ဘယ်လိုချိတ်ဆက်ထားတာလား တစ်နိုင်ငံနဲ့ တစ်နိုင်ငံ ဘယ်လိုချိတ်ဆက်ထားတာလဲ ကုန်းလမ်း/ရေလမ်း ဒီလိုမျိုးတွေပါ ချိတ်ဆက်ထားတဲ့ ပုံစံအပေါ်မူတည်ပြီး ပို့ဆောင်ဆက်သွယ်ဖို့နည်းတွေ
ကောင်းတာဆိုးတာတွေလည်းကွာမှာပေါ့။
Protocol ဆိုတာကတော့ Computer တစ်လုံးနဲ့တစ်လုံး Network အတွင်း ဘယ်လိုနည်းနဲ့ အချက်အလက်တွေ ပို့ပေးမလဲဆိုတာကို ခေါ်တာပါ။ ဥပမာ ရည်းစားစာ ပေးတယ်ထားပါတော့
သူ့စီကို စာရောက်ဖို့က မြန်တယ် အကုန်အကျသက်သာတယ် ဒါပေမဲ့ ပါးချခံရနိုင်တယ်။ Messenger တို့ဘာတို့ကပို့ရင်တော့ မြန်မယ် နည်းနည်း ပိုက်ဆံကုန်မယ် (ဒေတာဖိုး) ဒါပေမဲ့
Friend ဖြစ်ဖို့ acc သိဖို့ဘာညာလိုတယ်၊ စာတိုက်က ပို့ရင်ကျ ကြာမယ် အိမ်လိပ်စာသိဖို့လိုမယ် ပိုက်ဆံကုန်မယ် ဒါပေမဲ့ အမြဲလိုလို ပို့ရတယ်။ ဒီလောက်ဆိုရင် နားလည်လောက်မှာပါ။ (နားမလည်လည်း အောက်ရောက်မှထပ်ဖတ်)
IP Address ( Internet Protocol Address ) ဆိုတာကတော့ စောနက ဥပမာထဲက အိမ်လိပ်စာတို့ Messenger Acc တို့လိုပါပဲ Computer တစ်ခုနဲ့ တစ်ခု အချက်အလက်ပို့ဖို့ဆိုရင်
သူ့ရဲ့ တည်နေရာကို သိမှရမှာပါ ဒါကြောင့် Computer တစ်လုံးရဲ့ လိပ်စာကို IP Address လို့ခေါ်ကြပါတယ်။

=== Network Interface ထဲက Wired Networks နဲ့ Wireless Networks တွေအကြောင်း
Network Interfaces တွေမှာလည်း Wired နဲ့ Wireless ဆိုပြီး ပြန်ကွဲပါသေးတယ်။ ဥပမာ Router စက် ဒါမှမဟုတ် အများစုသိကြတဲ့ Wi-Fi ( တစ်ကဲ့ အခေါ်အဝေါ်အမှန်က Router နော် ) စက်ကနေ
Computer တွေကို Internet ချိတ်ရင် Ethernet ဆိုတဲ့ Wired Network နဲ့ Wi-Fi ( Wireless Fidelity ) လို့ခေါ်တဲ့ Wireless Network ဆိုပြီး နှစ်မျိုးရှိပါတယ်။
နှစ်မျိုးလုံးမှာတော့ သူတို့ အားသာချက်နဲ့ အားနည်းချက် ကိုယ်စီရှိပါတယ်။ Wired Network တွေရဲ့ အားသာချက်ကတော့ Wireless Network တွေထက် ပိုမြန်မြန် data တွေပို့ပေးနိုင်တယ်။
Wireless Network တွေလောက်အလုပ်သိပ့် မရှုပ်ဘူး ဝါယာ ကြိုးကနေချိတ်ပြီး အချက်အလက် တွေကို တိုက်ရိုက်ပေးတာဆိုတော့ကွာ တစ်ခုခု ဝင်နှောက်ယှက်လို့ နှေးသွားတာတို့ ဘာတို့ မဖြစ်ဘူး။
ဒါပေမဲ့ စောနကပြောတဲ့အတိုင်း ဝါယာကြိုးကနေ လုပ်ရတာဖြစ်တဲ့အတွက်ကွာ ချိတ်နိုင်တဲ့ အကွာအဝေးကကျ ကြိုးအပေါ်မှာပဲ မူတည်တယ် ပိုဝေးဝေး မှာနေပြီး ချိတ်ချင်ရင် ကြိုးရှည်ရှည်လိုတာပေါ့။
ဒါကြောင့် Wired Network တွေက Personal Use အဖြစ်သုံးကျတာပဲများတယ် ဥပမာဆို Gamer တွေတို့ Cloud Server တွေတို့ဆိုရင်ကျ လိုင်းကျတာဘာညာ မလိုချင်ဘူးကွာ
အဲ့တာကြောင့် Wired Network ထဲက Ethernet ဆိုတဲ့ ကောင်ကိုသုံးတယ်။ Wired Network ထဲက တစ်ချို့ကို ပြောရရင်တော့ စောနက Ethernet ပါတယ် USB တို့ Thunderbolt တို့ပါတယ်။
Wireless မှာကကျတော့ သူက ကြိုးကနေမဟုတ်ဘူး လေထဲကနေ လေထုကြိမ်နှုန်းတွေကိုသုံးပြီး အချက်အလက်တွေ ပို့ပေးတယ်။ ဒါကြောင့် Wireless တွေမှာဆို အမြန်နှုန်းကို frequency လို့ခေါ်တဲ့
ကြိမ်နှုန်းနဲ့တိုင်းတယ်။ ကြိမ်နှုန်းများလေလေ အချက်အလက် ပို့ပေးတာ မြန်လေလေဆိုပေမဲ့ သူ့ရဲ့ အကွာအဝေးက Limit ရှိပါတယ် Limit ကျော်သွားရင်တော့ ချိတ်ဆက်မှုက ရပ်တန့်သွားမှာပါ။
Wireless နဲ့ချိတ်ပြီး အချက်အလက်ပို့ကြတဲ့ Computer အချင်းချင်း ဝေးကွာသွားကြရင် ဖြစ်ဖြစ် သူတို့ နှစ်ခုကြားထဲမှာ နံရံလိုဟာမျိုးက ကြားခံနေရင်ပဲဖြစ်ဖြစ် ကြိမ်နှုန်းက နှေးသွားနိုင်ပါတယ်။
ဒီလိုပါပဲ လူနှစ်ယောက်ချစ်ကြလို့ ဝေးသွားရင်ဖြစ်ဖြစ် ကြားလူပေါ်လာရင်ဖြစ်ဖြစ် အချစ်တွေလည်း လျှော့သွားနိုင်ပါတယ်။
...
=== နည်းပညာပိုင်ဆိုင်ရာ ကိုယ်ရေးအချက်အလက်ဆိုတာဘာလဲ အရေးကြီးလား

=== နည်းပညာလုံခြုံရေး အကြောင်း
...
\
\
- Linus Walker [#link("https://facebook.com/walker.fbi")[Facebook Acc], #link("https://github.com/Walker-00")[Github Acc], #link("mailto:rissk_it@proton.me")[Mail]]
